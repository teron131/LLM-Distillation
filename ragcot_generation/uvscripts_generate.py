...
Provide only the final answer in the most appropriate format."""
    ...
    equivalence_prompt = f"""Compare these answers to determine if they are equivalent, considering different valid formats (e.g., "15%" vs "15 percent" vs "0.15", or "$1M" vs "$1,000,000").
